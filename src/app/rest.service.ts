...
export class RestService {
  ...
  readonly  endpoint = 'https://cors-anywhere.herokuapp.com/https://samples.openweathermap.org/';
  ...
  uploadFile (fileToUpload): Observable<any> {
    ...
    return this.http.post<any>(this.endpoint + 'fileUpload', JSON.stringify(fileToUpload), this.httpOptions).pipe(
      tap((fileUploadedResponse) => console.log(`added product w/ id=${fileUploadedResponse}`)),
